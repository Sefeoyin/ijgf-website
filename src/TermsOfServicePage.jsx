        ...
        <div className="legal-content">
          ...
          <section className="legal-section">
            ...
            <ul>
              ...
              <li><strong>Fenix AI Assistant:</strong> We provide an AI-powered trading assistant ("Fenix") that analyzes your account data, trade history, and open positions to generate informational responses. Fenix is powered by third-party AI models and is provided for educational and informational purposes only. Fenix's outputs do not constitute financial, investment, or trading advice. You acknowledge that AI-generated analysis may be inaccurate, incomplete, or outdated, and that you are solely responsible for any trading decisions you make. IJGF is not liable for any losses arising from reliance on Fenix's responses. Your conversation data and trading account data may be processed by our AI provider to generate responses; we do not use this data to train AI models. Usage of Fenix is subject to fair use limits as displayed within the feature.</li>
            </ul>
            <p>
